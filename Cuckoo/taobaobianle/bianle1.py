...
class Skuid_Color(object):
    ...
    def skuid_num(self, id):
        ...
        headers = {
            ...
            # "method": "GET",
            # "path": "/service/getData/1/p1/item/detail/sib.htm?itemId=562441235623&sellerId=747719712&modules=dynStock,qrcode,viewer,price,duty,xmpPromotion,delivery,upp,activity,fqg,zjys,couponActivity,soldQuantity,originalPrice,tradeContract&callback=onSibRequestSuccess",
            # "scheme": "https",
            # "accept": "*/*",
