...
class Sync:
    ...
    def normal(self):
        ...
        sql = u"""SELECT id_order_shipping, o.id_order, o.id_shipping, status_label, track_number, fetch_count ,summary_status_label,o.id_increment
                                                  ...
                                                  WHERE  o.id_shipping =226 AND track_number IS NOT NULL AND track_number != '' """
    ...
    def success(self):
        ...
        sql = u"""SELECT id_order_shipping, id_order, id_shipping, status_label, track_number, fetch_count ,summary_status_label
                  ...
                  WHERE id_shipping = 226 and summary_status_label = '已签收' or summary_status_label = '拒收' """
...
class SyncStatusThread(threading.Thread):
    ...
    def md5mode(self, stra):
        m = hashlib.md5()
        m.update(stra)
        return m.hexdigest()

    def fetch_coe(self, item):
        """COE抓取"""
        summary_status = ''
        status = ''
        logistics_time = ''
        ...
        id_order = ''
        tran_status_label = ''
        # summary_status = send_date(status, logistics_time, track, summary_status,'(98)').acquire_date()
        # summary_status_key = []
        # summary_status_dict = {}
        ...
        try:
            ...
            status_id = send_date(status, logistics_time, track, summary_status, '(226)', '').acquire_date_id()
            ...
            for i, j in sf_list:
                ...
                #tran_status = send_date(status, logistics_time, track, summary_status, '(226)', '').acquire_date()
                # if tran_status:
            ...
            print('%s --- %s --- %s' % (result['track'], result['status'], result['time']))
            return result
        except Exception, e:
            print e
            return result
