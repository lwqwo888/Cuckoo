...
class Sync:
    ...
    def normal(self):
        ...
        sql = u"""SELECT id_order_shipping, o.id_order, o.id_shipping, status_label, track_number, fetch_count ,summary_status_label
                          ...
                          WHERE  o.id_shipping in (178,96) AND track_number IS NOT NULL AND track_number != '' """
    ...
    def success(self):
        ...
        sql = u"""SELECT id_order_shipping, id_order, id_shipping, status_label, track_number, fetch_count ,summary_status_label
                                  ...
                                  WHERE  id_shipping in (178,96) and track_number IS NOT NULL AND track_number != ''
...
class SyncStatusThread(threading.Thread):
    ...
    def fetch_dec(self, item):
        ...
        try:
            ...
            status_id = send_date(status, logistics_time, track, 'hello', '(178, 96)','').acquire_date_id()
            if 'information' in result_data:
                ...
                for x in range(data_len):
                    ...
                    if not status:
                        status = "未上线"
                        tran_status_label = status
                    #tran_status = send_date(status, logistics_time, track, summary_status, '(178,96)', '').acquire_date()
                    #if tran_status:
