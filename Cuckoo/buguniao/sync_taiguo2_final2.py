...
class Sync:
    ...
    def normal(self):
        ...
        sql = u"""SELECT id_order_shipping, o.id_order, o.id_shipping, status_label, track_number, fetch_count ,summary_status_label
                  ...
                  WHERE  o.id_shipping in (84,254) AND track_number IS NOT NULL AND track_number != '' And is_settlemented = 0 AND o.id_order_status in (8,9,16,23) and o.id_increment != os.track_number"""
    ...
    def success(self):
        ...
        sql = u"""SELECT id_order_shipping, id_order, id_shipping, status_label, track_number, fetch_count ,summary_status_label
                  ...
                  WHERE id_shipping in(144,142,70) and track_number like 'C%' """
...
class SyncStatusThread(threading.Thread):
    ...
    def fetch_taiguo(self, item):
        ...
        try:
            ...
            url = "https://th.kerryexpress.com/en/track/?track=" + item['track_number']
            ...
            # bindIpObj.changeIp('')
            status_id = send_date(status, logistics_time, track, 'hello', '(84)', '').acquire_date_id()
            if len(data)<7:
                ...
                for x in range(len(node_list)):
                    ...
                    i += 1
                    tran_status = send_date(status, logistics_time, track, summary_status, '(84)','').acquire_date()
                    if tran_status:
                    ...
                    send_date(getstat, logistics_time, track, ' ', str(status_id[0]['id_shipping']),tran_status_label).insert_date()
            result['status'] = ''.join(getstat)
            result['time'] = ''.join(logistics_time)
