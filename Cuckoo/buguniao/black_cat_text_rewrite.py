...
from cat_date_text_final import send_date
def mian():
    reload(sys)
...
#def select_final_all_data():
#    for select__final_data in select__final_datas:
#        send_date(select__final_data['status_label'], str(select__final_data['date_at']),
#                  str(select__final_data['track_number']), ' ', str(select__final_data['id_shipping']),
#                  select__final_data['status_label']).insert_date()
