...
class Sync:
    ...
    def normal(self):
        ...
        sql = u"""SELECT id_order_shipping, o.id_order, o.id_shipping, status_label, track_number, fetch_count ,summary_status_label
                                  ...
                                  WHERE  o.id_shipping in(250,256) AND track_number IS NOT NULL AND track_number != '' And is_settlemented = 0 AND o.id_order_status in (8,9,16,23) and o.id_increment != os.track_number"""
    ...
    def success(self):
        ...
        sql = u"""SELECT a.id_order_shipping, a.id_order, a.id_shipping, a.status_label, a.track_number, a.fetch_count ,a.summary_status_label,b.id_increment
                      ...
                      WHERE  a.id_shipping in (250,256) and a.track_number not like 'SZT%' and a.track_number IS NOT NULL and a.track_number != ''
        ...
        try:
            ...
            if all_time_list:
                ...
                for logistics_time, status in tuerqi_quanheyue_list:
                    ...
                    #tran_status = send_date(status, logistics_time, track, summary_status, '(250,256)', '').acquire_date()
                    # print tran_status
                    # if tran_status:
                    ...
                    print 'status:-------:', status
                    print 'status:-------:', tran_status_label
