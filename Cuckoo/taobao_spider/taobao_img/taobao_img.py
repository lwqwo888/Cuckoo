...
def property_count(id):
    ...
    # img_url_obj = re.compile(r'//img\S*?\.jpg', re.S)
    img_url_obj = re.compile(r'//\S*?\.jpg', re.S)
    img_url_list = img_url_obj.findall(html)
...
if __name__ == '__main__':
    ...
    url = 'https://item.taobao.com/item.htm?spm=a219r.lm874.14.31.5dc9e78e7Fcl7j&id=561495525977&ns=1&abbucket=16#detail'
    id = url_process(url)
    property_count(id)