...
url = 'https://detail.tmall.com/item.htm?spm=608.7065813.ne.1.128f6324pjwY0E&id=557200845972&tracelog=jubuybigpic&skuId=3618163606214'
headers = {
...
# print html
res = etree.HTML(html)
ron = res.xpath('''//*[@id="J_DetailMeta"]/div[1]/div[1]/div/div[4]/div/div/dl[1]/dd/ul//text()''')
for i in ron:
    print i.replace('\n', '').replace('\t', '').replace('\r', '').strip()

'//*[@id="J_DetailMeta"]/div[1]/div[1]/div/div[4]/div/div/dl[2]/dd/ul/li[2]/a'